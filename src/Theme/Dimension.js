...
const Dimension = {
  ...
  CustomBlackFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Black',
  CustomBoldFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Bold',
  CustomExtraBoldFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-ExtraBold',
  // CustomExtraLightFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-ExtraLight',
  CustomLightFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Light',
  CustomMediumFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Medium',
  CustomRegularFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Regular',
  CustomSemiBoldFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-SemiBold',
  //CustomSemThinFont: Platform.OS == 'ios' ? 'Rubik' : 'Rubik-Thin',
  ...
  margin38: normalize(38),
  margin40: normalize(40),
  margin49: normalize(49),
  ...
  margin42: normalize(42),
  margin55: normalize(55),
  margin89: normalize(89),
  height5: normalize(5),
  height10: normalize(10),
  height11: normalize(11),
  height14: normalize(14),
  ...
  width114: normalize(114),
  width130: normalize(130),
  width133: normalize(133),
  ...
  width262: normalize(262),
  width315: normalize(315),
