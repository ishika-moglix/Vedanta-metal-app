...
export default StyleSheet.create({
  ...
  errorText: {
    ...
    top: Platform.OS === 'ios' ? 0 : -Dimension.margin3,
  },
  result: {
    fontSize: Dimension.font14,
    textAlign: 'center',
  ...
  container: {
    paddingHorizontal: Dimension.padding20,
    paddingTop: Platform.OS === 'ios' ? Dimension.padding20 : Dimension.padding50,
  },
  ...
  titleWrap: {
    marginVertical: Dimension.margin49,
  },
  title: {
    // fontFamily: Dimension.CustomMediumFont,
    fontWeight: '500',
  ...
  loginBtn: {
    ...
    marginTop: Platform.OS === 'ios' ? Dimension.margin35 : Dimension.margin50,
    marginBottom: Dimension.margin20,
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  signupBtn: {
    ...
    justifyContent: 'center',
    paddingVertical: Dimension.padding15,
    // marginBottom: Dimension.margin89,
    elevation: 5,
    shadowColor: '#00000029',
